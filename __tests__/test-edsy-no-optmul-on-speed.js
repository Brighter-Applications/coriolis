/**
 * Test EDSY values assuming optmul does NOT apply to speed multipliers
 */
...
// But optmul might only apply to acceleration, not speed!
...
// Speed multipliers NOT modified (optmul doesn't apply)
const modMinmulSpeed = eptBase.minmulspeed;
const modOptmulSpeed = eptBase.optmulspeed;
const modMaxmulSpeed = eptBase.maxmulspeed;
...
console.log('Testing EDSY with NO optmul on speed multipliers');
console.log('=================================================\n');

console.log('EDSY reports:');
console.log(`  Optimal Mass: -3.7%`);
console.log(`  Optimal Multiplier: +46.0% (acceleration only)`);
console.log('');

console.log('Modified thruster stats:');
console.log(`  Masses: ${modMinmass.toFixed(3)} / ${modOptmass.toFixed(3)} / ${modMaxmass.toFixed(3)}`)  ;
console.log(`  Speed muls: ${modMinmulSpeed.toFixed(4)} / ${modOptmulSpeed.toFixed(4)} / ${modMaxmulSpeed.toFixed(4)} (NOT modified)`);
console.log('');
